...
player = Player('monkey3.png',75,75,400,400,12,8)

mbspeed1 = -0.5
bobrs1 = []
bobr1 = GameSprite('BOBR1.png',75,75,300,285)
bobrs1.append(bobr1)
mbspeed2 = -0.5
bobrs2 = []
bobr2 = GameSprite('BOBR1.png',75,75,300,915)
bobrs2.append(bobr2)
pbspeed3 = 0.4
bobrs3 = []
bobr3 = GameSprite('BOBR1.png',75,75,1180,925)
bobrs3.append(bobr3)
pbspeed4 = 0.4
bobrs4 = []
bobr4 = GameSprite('BOBR1.png',75,75,1370,50)
bobrs4.append(bobr4)
mbspeed5 = -0.5
bobrs5 = []
bobr5 = GameSprite('BOBR1.png',75,75,1385,735)
bobrs5.append(bobr5)
...
while run:        
    ...
    if len(bobrs1) != 0:
        for i in bobrs1:
            i.reset()
        for i in bobrs1:
            if sprite.collide_rect(i,tochka11):
                mbspeed1 += 1
            elif sprite.collide_rect(i,tochka12):
                mbspeed1 -= 1
